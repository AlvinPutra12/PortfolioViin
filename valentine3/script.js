const CONFIG = {
    mainQuestion: "Gimana Kalo Kita Balikan lagi?",
    ...
    confirmText: "Mulai dari sekarang Dina resmi jadi…",
    badgeText: "pacar VINO lagi 23-07-26",
    nextButton: "Lanjut ",
    ...
    collageSubtitle: "Sejak kamu hadir, hal sederhana pun terasa istimewa. , my favorite person. 💕",
    nextCollageButton: "Satu halaman lagi… ",
    finalTitle: "sedikit kata kata, 💞",
    finalMessage: `Jadi beneran galak kan balekan samo vino hehhe, ini serius bukan maen maen, capek vino kalo harus ngalah, keburu dina di ambek wong laen lagi hmmm, biar dak di tanyo tanyo trus samo tante tante,`,
